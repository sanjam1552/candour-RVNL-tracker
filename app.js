...
const RVNL_QUERIES = [
    { category: "Own News", q: "(\"Rail Vikas Nigam Limited\" OR \"Rail Vikas Nigam\" OR RVNL OR \"Pradeep Gaur\" OR \"MP Singh\" OR \"Mritunjay Pratap Singh\" OR \"Saleem Ahmad\") when:7d" },
...
function isArticleRelevant(art) {
    ...
    if (state.activeClient === "RVNL") {
        const mentionsBrand = combined.includes("rvnl") || combined.includes("rail vikas") || combined.includes("pradeep gaur") || combined.includes("mp singh") || combined.includes("mritunjay pratap singh") || combined.includes("mritunjay pratap") || combined.includes("saleem ahmad");
